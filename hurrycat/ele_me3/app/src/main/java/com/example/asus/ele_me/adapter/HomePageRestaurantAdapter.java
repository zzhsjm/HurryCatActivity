package com.example.asus.ele_me.adapter;
...
public class HomePageRestaurantAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //holder.logo.setImageDrawable(mlist.get(position).getLogo());
        ...
        holder.logo.setImageResource(mlist.get(position).getLogo());        //ImageLoader.getInstance().displayImage(mlist.get(position).getLogo(), holder.logo);
