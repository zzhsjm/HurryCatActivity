...
import com.example.asus.ele_me.MainActivity;
import com.example.asus.ele_me.R;
import com.example.asus.ele_me.activity.DianPingWebActivity;
import com.example.asus.ele_me.adapter.HomePageRestaurantAdapter;
import com.example.asus.ele_me.entity.RestaurantEntity;
import com.example.asus.ele_me.util.RefreshableListView;
import com.example.asus.ele_me.util.RefreshableListView.OnRefreshListener;
...
public class HomeFragment extends Fragment implements OnClickListener {
    ...
    private ImageView head_pic1;
    private ImageView head_pic2;
    private ImageView head_pic3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        head_pic = (ImageView) listHeaderView
                .findViewById(R.id.iv_home_head_4);
        head_pic1 = (ImageView) listHeaderView
                .findViewById(R.id.iv_home_head);
        head_pic2 = (ImageView) listHeaderView
                .findViewById(R.id.iv_home_head_2);
        head_pic3 = (ImageView) listHeaderView
                .findViewById(R.id.iv_home_head_3);
    ...
    public void setListener() {
        ...
        head_pic1.setOnClickListener(new OnClickListener() {
        ...
        head_pic2.setOnClickListener(new OnClickListener() {
        ...
        head_pic3.setOnClickListener(new OnClickListener() {
    ...
    private void getDate() {
        ...
        restaurant1.setLogo( R.drawable.pic_jigongbao );
        ...
        restaurant2.setLogo(R.drawable.pic_jixiang);
        restaurant2.setName("吉祥馄饨");
        ...
        restaurant3.setLogo(R.drawable.pic_milishi);
        ...
        restaurant4.setLogo( R.drawable.pic_shaxian);
        ...
        restaurant5.setLogo(R.drawable.pic_shiguifan);
